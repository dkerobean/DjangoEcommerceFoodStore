...
def view_products(request):
    ...
    return render(request,
                  'admin_dashboard/product/view_products.html',
                  context
                  )
...
def product_detail(request, pk):
    ...
    return render(request,
                  'admin_dashboard/product/product_details.html',
                  context
                  )
...
def edit_product(request, pk):
    ...
    return render(request,
                  'admin_dashboard/product/edit_product.html',
                  context
                  )
...
def delete_product(request, pk):
    ...
    return render(request, 'admin_dashboard/product/view_products.html')
...
def user_review(request):
    ...
    return render(request,
                  'admin_dashboard/reviews/view_reviews.html',
                  context
                  )
